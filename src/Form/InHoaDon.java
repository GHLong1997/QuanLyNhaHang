...
public class InHoaDon extends JFrame{
	...
	public InHoaDon(String title,Ban ba,String NgayH,String MaHd)
	{
		super(title);
		this.ban =ba;
	...
	private void HienThiThongTin() {
		...
		try{
			...
			llblT.setText(S.toString()+"Đ");
			llblT2.setText(T.toString()+"Đ");
			llblT4.setText(ST.toString()+"Đ");
	...
	private void addControls() {
		...
		JLabel lbl1 = new JLabel("ABC RESTAURANT");
		...
		JLabel lbl2 = new JLabel("Tổ 8, Tứ Hạ, Hương Trà, Thừa Thiên Huế");
		lbl2.setForeground(Color.DARK_GRAY);
		pn2.add(lbl2);
		
		JPanel pn3 = new JPanel();
		pn3.setLayout(new FlowLayout(FlowLayout.RIGHT));
		JLabel lbl3 = new JLabel("0987284147");
		...
		tbl = new JTable(dtm);
		JScrollPane sc11=new JScrollPane(tbl,JScrollPane.VERTICAL_SCROLLBAR_NEVER,JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
