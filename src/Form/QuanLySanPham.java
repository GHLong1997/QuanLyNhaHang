...
public class QuanLySanPham extends JFrame {
	...
	JTable tbl=null;
	JTextField txtMa,txtTen,txtSo,txtDVT,txtDonGia,txtMa1,txtTen1;
	JButton btnThem,btnXoa,btnTaoMoi,btnTim,btnThem1,btnXoa1,btnSua1,btnUpdate,btnLog;
	Vector<SanPham> dsSP;
	Vector<DanhMuc>dsDM;
	DanhMuc dmSelected;
	SanPham spSelected;
	...
	public void LayDanhSachDanhMuc() {
	...
	protected void LayDanhSachHangHoa() {
		if(listDM.getSelectedIndex()==-1)return;
	...
	private void addControls() {
		...
		pnTop.setPreferredSize(new Dimension(0, 80));
		...
		JSplitPane spBottom=new JSplitPane(JSplitPane.HORIZONTAL_SPLIT,pnLeftofBottom,pnRightofBottom);
		pnBottom.add(spBottom,BorderLayout.CENTER);
		
		listDM = new JList<DanhMuc>();
		JScrollPane sc = new JScrollPane(listDM,JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
		pnLeftofBottom.add(sc,BorderLayout.CENTER);
		
		TitledBorder titleBorder1=new TitledBorder(BorderFactory.createLineBorder(Color.RED), "Danh mục sản phẩm",TitledBorder.CENTER, 0);
	    titleBorder1.setTitleColor(Color.BLUE);
	    pnLeftofBottom.setBorder(titleBorder1);
	    
	    JPanel pnBottomOfLeftOfBottom =new JPanel();
	    pnBottomOfLeftOfBottom.setLayout(new BoxLayout(pnBottomOfLeftOfBottom, BoxLayout.Y_AXIS));
	    ...
	    pnBottomOfRightofBottom.setLayout(new BoxLayout(pnBottomOfRightofBottom, BoxLayout.Y_AXIS));
	    ...
	    pnBottomOfRightofBottom.add(pnMa);
	    ...
	    pnBottomOfRightofBottom.add(pnTen);
	    ...
	    pnBottomOfRightofBottom.add(pnDVT);
	    ...
	    pnBottomOfRightofBottom.add(pnDonGia);
	    ...
	    btnXoa.setIcon(new ImageIcon("img/12.png"));
	    btnTim = new JButton("Tìm");
	    btnTim.setIcon(new ImageIcon("img/13.png"));
	    btnUpdate = new JButton("Sửa");
	    btnUpdate.setIcon(new ImageIcon("img/14.png"));
	    btnThem1.setIcon(new ImageIcon("img/11.png"));
	    btnXoa1.setIcon(new ImageIcon("img/12.png"));
	    btnSua1.setIcon(new ImageIcon("img/14.png"));
